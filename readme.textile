...
It contains a few lines of code taken from http://www.ravelrumba.com/blog/watch-compile-less-command-line/comment-page-1/#comment-2464
...
<pre>
cd path/to/your/project/assets/css
watchless
</pre>

h3. Future plans

Add option @-x@ and pass it to @lessc@ if present.
Add option to watch a single file only.
